		...
		<div class="container">
					...
					<ul class="nav nav-tabs">
						<li class="nav-item dropdown" style="width: 20%; text-align: center;">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" data-toggle="modal" data-target="#ExemploModalCentralizado"><i class="fas fa-door-open"></i> Sair</a>
							</div>
						</li>
			...
			<div class="row" style="text-align: center; margin-top: 10px;">
				...
				<div class="col-md-7">
					...
					<a href="foruns/tecnologia.php">Fórum Tecnologia</a>
				</div>
